...
const createProffy = require('./createProffy')  // Função criada para ser importada no documento createProffy.js


Database.then(async (db) => {
  // Inserir dados
  proffyValue = { // Atalho para receber o objeto
  ...
  // Os dados estão sendo agrupados em uma array
  classScheduleValues = [
